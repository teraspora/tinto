// scripts/css_colours.js
// Got from W3schools w3colors.js
...
const getCssColourName = hexValue => !colourValues.includes(hexValue) ? `` : colourNames[colourValues.findIndex(x => x == hexValue)];